...
export const metadata: Metadata = buildMetadata({
  title: "Монтаж кондиционеров в Мурино — Климат 365",
  description:
    "Монтаж, обслуживание и ремонт кондиционеров в Мурино. Работаем в ЖК Девяткино, Мурино и новых комплексах района. Выезд ~20 минут. Фиксированная смета, гарантия.",
  path: "/rajony/murino",
});
  ...
  return (
    <main>
      <section className="bg-brand-dark py-14">
        <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
          <nav className="mb-4 flex flex-wrap gap-1 text-xs text-white/40">
            ...
            <span>/</span>
            <span className="text-white/60">Мурино</span>
          </nav>
          <h1 className="text-3xl font-bold text-white sm:text-4xl">
            Монтаж и обслуживание кондиционеров в Мурино
          </h1>
          <p className="mt-4 max-w-2xl text-white/70 leading-relaxed">
            Мурино — один из самых быстро растущих районов Ленобласти: здесь активно сдаются новые корпуса ЖК Девяткино, Мурино и десятки соседних комплексов. Высокая плотность застройки и большое число новосёлов означают постоянный спрос на монтаж климатической техники. Выезжаем из СПб примерно за 20 минут, без доплат за выезд.
          </p>
      ...
      <div className="mx-auto max-w-5xl space-y-14 px-4 py-14 sm:px-6 lg:px-8">
        ...
        <section>
          <h2 className="text-2xl font-bold text-text-dark">Наши услуги в Мурино</h2>
        ...
        <section className="rounded-2xl bg-brand-dark p-8 text-center">
          <h2 className="text-2xl font-bold text-white">Нужен кондиционер в Мурино?</h2>
          <p className="mt-2 text-white/70">
            Выезжаем в Мурино ежедневно. Оставьте заявку или позвоните — рассчитаем стоимость за несколько минут.
          </p>
