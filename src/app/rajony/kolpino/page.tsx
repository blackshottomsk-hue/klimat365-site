...
export const metadata: Metadata = buildMetadata({
  title: "Монтаж кондиционеров в Колпино — Климат 365",
  description:
    "Монтаж, обслуживание и ремонт кондиционеров в Колпино. Работаем в жилых кварталах и частных домах района. Выезд ~30 минут. Фиксированная смета, гарантия на работы.",
  path: "/rajony/kolpino",
});
...
export default function KolpinoPage() {
  return (
    <main>
      <section className="bg-brand-dark py-14">
        <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
          <nav className="mb-4 flex flex-wrap gap-1 text-xs text-white/40">
            ...
            <span>/</span>
            <span className="text-white/60">Колпино</span>
          </nav>
          <h1 className="text-3xl font-bold text-white sm:text-4xl">
            Монтаж и обслуживание кондиционеров в Колпино
          </h1>
          <p className="mt-4 max-w-2xl text-white/70 leading-relaxed">
            Колпино — промышленный и жилой район на юге Санкт-Петербурга. Здесь соседствуют советские кварталы, частные дома и более новые жилые дома. Монтаж кондиционеров востребован как в квартирах многоэтажек, так и в частном секторе, где требуется прокладка длинной трассы по фасаду. Выезжаем примерно за 30 минут.
          </p>
      ...
      <div className="mx-auto max-w-5xl space-y-14 px-4 py-14 sm:px-6 lg:px-8">
        ...
        <section>
          <h2 className="text-2xl font-bold text-text-dark">Наши услуги в Колпино</h2>
        ...
        <section className="rounded-2xl bg-brand-dark p-8 text-center">
          <h2 className="text-2xl font-bold text-white">Нужен кондиционер в Колпино?</h2>
          <p className="mt-2 text-white/70">
            Выезжаем в Колпино ежедневно. Оставьте заявку или позвоните — рассчитаем стоимость за несколько минут.
          </p>
