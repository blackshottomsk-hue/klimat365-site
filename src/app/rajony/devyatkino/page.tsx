...
export const metadata: Metadata = buildMetadata({
  title: "Монтаж кондиционеров в Девяткино — Климат 365",
  description:
    "Монтаж, обслуживание и ремонт кондиционеров в Девяткино. Работаем в новых ЖК зоны Мурино–Девяткино. Выезд ~20 минут. Фиксированная смета, гарантия на работы.",
  path: "/rajony/devyatkino",
});
...
export default function DevyatkinoPage() {
  return (
    <main>
      <section className="bg-brand-dark py-14">
        <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
          <nav className="mb-4 flex flex-wrap gap-1 text-xs text-white/40">
            ...
            <span>/</span>
            <span className="text-white/60">Девяткино</span>
          </nav>
          <h1 className="text-3xl font-bold text-white sm:text-4xl">
            Монтаж и обслуживание кондиционеров в Девяткино
          </h1>
          <p className="mt-4 max-w-2xl text-white/70 leading-relaxed">
            Девяткино — конечная станция метро и точка роста целого жилого кластера. Зона Мурино–Девяткино активно застраивается: сдаются новые дома, прибывают тысячи новосёлов. Мы регулярно работаем здесь и выезжаем примерно за 20 минут. Опыт монтажа в высотных новостройках с длинными трассами и закрытыми лоджиями.
          </p>
      ...
      <div className="mx-auto max-w-5xl space-y-14 px-4 py-14 sm:px-6 lg:px-8">
        ...
        <section>
          <h2 className="text-2xl font-bold text-text-dark">Наши услуги в Девяткино</h2>
        ...
        <section className="rounded-2xl bg-brand-dark p-8 text-center">
          <h2 className="text-2xl font-bold text-white">Нужен кондиционер в Девяткино?</h2>
          <p className="mt-2 text-white/70">
            Выезжаем в Девяткино ежедневно. Оставьте заявку или позвоните — рассчитаем стоимость за несколько минут.
          </p>
