...
export const metadata: Metadata = buildMetadata({
  title: "Монтаж кондиционеров в Кудрово — Климат 365",
  description:
    "Монтаж, обслуживание и ремонт кондиционеров в Кудрово. Работаем в ЖК Охта Парк, Звёздный, Новый Оккервиль. Выезд из СПб ~25 минут. Фиксированная смета, гарантия на работы.",
  path: "/rajony/kudrovo",
});
...
export default function KudrovoPage() {
  return (
    <main>
      <section className="bg-brand-dark py-14">
        <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
          <nav className="mb-4 flex flex-wrap gap-1 text-xs text-white/40">
            ...
            <span>/</span>
            <span className="text-white/60">Кудрово</span>
          </nav>
          <h1 className="text-3xl font-bold text-white sm:text-4xl">
            Монтаж и обслуживание кондиционеров в Кудрово
          </h1>
          <p className="mt-4 max-w-2xl text-white/70 leading-relaxed">
            Кудрово — один из самых активно застраивающихся районов Ленобласти. Здесь сдаются крупные ЖК: Охта Парк, Звёздный, Новый Оккервиль. В новых домах кондиционер нужен уже в первое лето — мы выезжаем из СПб примерно за 25 минут и работаем без доплат за выезд за КАД.
          </p>
      ...
      <div className="mx-auto max-w-5xl space-y-14 px-4 py-14 sm:px-6 lg:px-8">
        ...
        <section>
          <h2 className="text-2xl font-bold text-text-dark">Наши услуги в Кудрово</h2>
        ...
        <section className="rounded-2xl bg-brand-dark p-8 text-center">
          <h2 className="text-2xl font-bold text-white">Нужен кондиционер в Кудрово?</h2>
          <p className="mt-2 text-white/70">
            Выезжаем в Кудрово ежедневно. Оставьте заявку или позвоните — рассчитаем стоимость за несколько минут.
          </p>
