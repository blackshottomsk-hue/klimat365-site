...
export const metadata: Metadata = buildMetadata({
  title: "Монтаж кондиционеров в Пушкине — Климат 365",
  description:
    "Монтаж, обслуживание и ремонт кондиционеров в Пушкине (Царское Село). Работаем в коттеджах и новых ЖК исторического района. Выезд ~35 минут. Гарантия на работы.",
  path: "/rajony/pushkin",
});
...
export default function PushkinPage() {
  return (
    <main>
      <section className="bg-brand-dark py-14">
        <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
          <nav className="mb-4 flex flex-wrap gap-1 text-xs text-white/40">
            ...
            <span>/</span>
            <span className="text-white/60">Пушкин</span>
          </nav>
          <h1 className="text-3xl font-bold text-white sm:text-4xl">
            Монтаж и обслуживание кондиционеров в Пушкине
          </h1>
          <p className="mt-4 max-w-2xl text-white/70 leading-relaxed">
            Пушкин (Царское Село) — исторический район к югу от Санкт-Петербурга. Здесь много коттеджей и частных домов в зелёных кварталах, а рядом активно строятся новые жилые комплексы. Монтаж кондиционеров в частных домах требует особого внимания к прокладке трассы — мы с этим хорошо знакомы. Выезжаем примерно за 35 минут.
          </p>
      ...
      <div className="mx-auto max-w-5xl space-y-14 px-4 py-14 sm:px-6 lg:px-8">
        ...
        <section>
          <h2 className="text-2xl font-bold text-text-dark">Наши услуги в Пушкине</h2>
        ...
        <section className="rounded-2xl bg-brand-dark p-8 text-center">
          <h2 className="text-2xl font-bold text-white">Нужен кондиционер в Пушкине?</h2>
          <p className="mt-2 text-white/70">
            Выезжаем в Пушкин ежедневно. Оставьте заявку или позвоните — рассчитаем стоимость за несколько минут.
          </p>
